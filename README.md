...
$ wget https://github.com/daxingplay/saml2alicloud/releases/download/v${CURRENT_VERSION}/saml2aws_${CURRENT_VERSION}_linux_amd64.tar.gz
...
Flags:
  ...
  -i, --provider=PROVIDER      This flag is obsolete. See: https://github.com/daxingplay/saml2alicloud#configuring-idp-accounts
