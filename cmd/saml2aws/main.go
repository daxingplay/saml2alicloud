...
import (
	...
	"github.com/daxingplay/saml2alicloud/v2/cmd/saml2aws/commands"
...
func main() {
	...
	provider := app.Flag("provider", "This flag is obsolete. See: https://github.com/daxingplay/saml2alicloud/v2#configuring-idp-accounts").Short('i').Enum("Akamai", "AzureAD", "ADFS", "ADFS2", "Ping", "JumpCloud", "Okta", "OneLogin", "PSU", "KeyCloak")
	...
	if *provider != "" {
		log.Println("The --provider flag has been replaced with a new configure command. See https://github.com/daxingplay/saml2alicloud/v2#adding-idp-accounts")
		os.Exit(1)
	}
